...
const handlePageChange = (page) => {
  ...
  return (
    <div className="container">
      <h4 style={{ marginLeft: '190px', marginTop: '200px', marginBottom: '-80px' }}>Customers</h4>
      <div className="header" style={{ width: '80%', marginTop: '100px', marginBottom: '-50px' }}>
        <div style={{ display: "flex", justifyContent: "right", marginRight: "10%" }}></div>
      </div>
